...
Output: `desktop/dist/Vibebells Setup 1.1.0.exe` (installer) and `Vibebells 1.1.0.exe` (portable)
...
Output: `desktop/dist/Vibebells-1.1.0.dmg`
...
Output: `desktop/dist/Vibebells-1.1.0.AppImage` and `.deb`
