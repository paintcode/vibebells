...
Output: `desktop/dist/Vibebells Setup 1.0.2.exe` (installer) and `Vibebells 1.0.2.exe` (portable)
...
Output: `desktop/dist/Vibebells-1.0.2.dmg`
...
Output: `desktop/dist/Vibebells-1.0.2.AppImage` and `.deb`
