...
- **Windows**: `Vibebells Setup 1.2.0.exe` or `Vibebells 1.2.0.exe` (portable)
- **macOS**: `Vibebells-1.2.0.dmg` (coming soon)
- **Linux**: `Vibebells-1.2.0.AppImage` or `.deb` (coming soon)
