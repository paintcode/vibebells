...
- **Windows**: `Vibebells Setup 1.1.0.exe` or `Vibebells 1.1.0.exe` (portable)
- **macOS**: `Vibebells-1.1.0.dmg` (coming soon)
- **Linux**: `Vibebells-1.1.0.AppImage` or `.deb` (coming soon)
