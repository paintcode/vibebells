...
- **Windows**: `Vibebells Setup 1.0.2.exe` or `Vibebells 1.0.2.exe` (portable)
- **macOS**: `Vibebells-1.0.2.dmg` (coming soon)
- **Linux**: `Vibebells-1.0.2.AppImage` or `.deb` (coming soon)
