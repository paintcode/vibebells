...
class TestExperienceLevelConstraints:
    """Test that experience-level constraints are enforced"""
    ...
    def test_all_players_respect_max_bells(self, mixed_players, config):
    ...
    def test_beginners_have_minimum_bells(self, mixed_players, config):
...
class TestPlayerExpansion:
    """Test player expansion when insufficient capacity"""
    
    def test_expansion_when_capacity_insufficient(self):
    ...
    def test_no_expansion_when_capacity_sufficient(self):
...
class TestBalancedStrategy:
    """Test balanced strategy behavior"""
    ...
    def test_balanced_strategy_distributes_evenly(self, config):
    ...
    def test_balanced_strategy_with_all_beginners(self, config):
...
class TestStrategyBehavior:
    ...
    def test_experienced_first_prefers_experienced_players(self, mixed_players, config):
    ...
    def test_all_strategies_respect_constraints(self, mixed_players, config):
